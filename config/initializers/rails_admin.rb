# RailsAdmin config file. Generated on September 05, 2012 18:32
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ideas', 'Admin']
  ...
  # config.excluded_models = [Export, Note, User, UserEmail]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Export, Note, User, UserEmail]
  ...
  #     configure :body, :text 
  #     configure :from_address, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :unique_id, :string 
  #     configure :user_id, :integer         # Hidden 
  #     configure :share_id, :string 
  ...
  #     configure :user_emails, :has_many_association 
  #     configure :exports, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  ...
  #     configure :unique_id, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
